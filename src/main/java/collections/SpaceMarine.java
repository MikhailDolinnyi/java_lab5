...
public class SpaceMarine implements FieldValidator, Comparable<SpaceMarine>{
         ...
         */
        private static Long incNextId(){return nextId++;}
        ...
        public boolean validate() {
                ...
                if(this.achievements == null){return false;}
        ...
        public boolean equals(Object obj) {
                ...
                if (this.health!= that.health){return false;}
                if (this.height != that.height){return false;}
                if (this.chapter != that.chapter){return false;}
